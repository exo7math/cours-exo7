...
Voici le but ultime de ce cours : le chiffrement RSA.
...
\begin{itemize}
  \item elle choisit deux nombres premiers distincts $\prive{p}$ et $\prive{q}$ (dans la pratique ce sont de très grands nombres,
